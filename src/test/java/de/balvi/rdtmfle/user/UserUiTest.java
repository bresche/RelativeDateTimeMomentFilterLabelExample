package de.balvi.rdtmfle.user;

import de.balvi.rdtmfle.entity.User;
import de.balvi.rdtmfle.screen.user.UserBrowse;
import de.balvi.rdtmfle.screen.user.UserEdit;
import de.balvi.rdtmfle.test_support.UiIntegrationTest;
