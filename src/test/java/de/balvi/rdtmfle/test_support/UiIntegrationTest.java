package de.balvi.rdtmfle.test_support;

import de.balvi.rdtmfle.RelativeDateTimeMomentFilterLabelExampleApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "rdtmfle_MainScreen", screenBasePackages = "de.balvi.rdtmfle.screen")
@ContextConfiguration(classes = {RelativeDateTimeMomentFilterLabelExampleApplication.class, UiTestAssistConfiguration.class})
